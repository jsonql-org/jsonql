...
const config = {
  port: 0,
  webroot: [
    '/home/joel/Projects/jsonql-org/jsonql/packages/validator-core/tests/qunit/webroot',
    '/home/joel/Projects/jsonql-org/jsonql/packages/validator-core/tests/qunit/files'
  ],
  open: true,
  reload: true,
