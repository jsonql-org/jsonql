export { DEFAULT_TYPE, // this is a mistake should move back to the validation
DATA_KEY, ERROR_KEY, TYPE_KEY, OPTIONAL_KEY, ENUM_KEY, ARGS_KEY, CHECKER_KEY, ALIAS_KEY, ARRAY_TYPE_LFT, ARRAY_TYPE_RGT, ARRAY_TS_TYPE_LFT, ARRAY_TYPE, OBJECT_TYPE, STRING_TYPE, BOOLEAN_TYPE, NUMBER_TYPE, KEY_WORD, OR_SEPERATOR } from '@jsonql/constants';
...
export { ARGS_NOT_ARRAY_ERR, PARAMS_NOT_ARRAY_ERR, EXCEPTION_CASE_ERR, UNUSUAL_CASE_ERR, RETURNS_NAME, JSONQL_PARAMS_VALIDATOR_INFO, };
