...
const config = {
  port: 0,
  webroot: [
    '/home/joel/Projects/jsonql-org/jsonql/packages/validators/tests/qunit/webroot',
    '/home/joel/Projects/jsonql-org/jsonql/packages/validators/tests/qunit/files'
  ],
  open: true,
  reload: true,
  testFilePattern: '*.qunit.js',
  baseDir: '/home/joel/Projects/jsonql-org/jsonql/packages/validators/tests'
}
